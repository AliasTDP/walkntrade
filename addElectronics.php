...
<body onload="javascript:initDropBox()">
	...
	<div class="wrapper">
		<div id="addTable" class="boxStyle1" >
			<p><h1 style="text-align:center">Post electronics or games.</h1></p>
		<table style="width:100%">
			<form action="javascript:void(0)" method="POST" name="electronics" onSubmit="addElectronics()">
				<tr>
					<td colspan="2">
						<input type="text" name="Name" placeholder="*Name of your post">
					</td>
				</tr>
				<tr class="errorClass">
					<td id="errTitle"></td>
				...
				<tr>
					<td colspan="2">
						<textarea name="Details" placeholder="*A short description of your item here."></textarea>
					</td>
				</tr>
				<tr class="errorClass">
				...
				<tr>
					<td colspan="2">
						<input type="text" name="Tags" placeholder="*Descriptive tags about your item">
					</td>
				</tr>
				<tr class="errorClass">
