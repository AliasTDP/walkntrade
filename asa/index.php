...
<html>
	<head>
		<title>WalkNtrade.com SPECIAL PAGE ADD ASA</title>
	...
	<body onload="javascript:initDropBox()">
		...
		<div class="wrapper">
			...
			<div id="addTable" style="border-left:5px solid red;border-right:5px solid red;color:red">
				<p>
					<h1 style="text-align:center">*Special event for ASA</h1>
				</p>
				<table style="width:100%">
					<form action="javascript:void(0)" method="POST" name="asa" onSubmit="addASA()">
						<tr>
					<td colspan="2">
						<input type="text" name="Name" placeholder="*Short name here">
					</td>
				</tr>
				<tr class="errorClass">
					<td id="errTitle"></td>
				...
				<tr>
					<td colspan="2">
						<textarea name="Details" placeholder="*Description here"></textarea>
					</td>
				</tr>
				<tr class="errorClass">
				...
				<tr>
					<td colspan="2">
						<input type="text" name="Tags" placeholder="*Descriptive tags here">
					</td>
				</tr>
				<tr class="errorClass">
